...
const Home = () => {
    ...
    useEffect(() => localStorage.getItem('initials') ?? router.push('/settings'), [])
    ...
    return (
        <>
            <Head>
                <link rel="canonical" href="https://citecreator.netlify.app"></link>
